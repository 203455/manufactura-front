                    ...
                    <Grid item xs={10} md={8}>
                        <Box className='Box_item'  justifyContent='center' textAlign='center'>         
                            <Grid container spacing={2}>
                                ...
                                <Grid className="Grid_item" item xs={12} md={3}>
                                    <Button sx={{marginTop: '1rem', fontWeight: 'bold', marginBottom:'1.5rem'}}  onClick={handleClickOpen}>
                                        Ver más
                                    </Button>
                                    <BootstrapDialog
                                        onClose={handleClose}
                                    ...
                                    >
                                        ...
                                        <DialogActions>
                                        <Button color="secondary" disabled autoFocus>
                                            Aprobando
                                        </Button>
...
export default List_solicitudes;